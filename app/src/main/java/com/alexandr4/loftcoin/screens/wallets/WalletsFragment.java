...
import com.alexandr4.loftcoin.screens.currencies.CurrenciesBottomSheet;
import com.alexandr4.loftcoin.screens.currencies.CurrenciesBottomSheetListener;
...
public class WalletsFragment extends Fragment implements CurrenciesBottomSheetListener {
    ...
    private void initInputs() {
        ...
        viewModel.transactions().observe(this, Transactions -> transactionsAdapter.setTransactions(Transactions));
    }
